...
const MainSection = () => {
    const {
        ...
        approveYourself,
        approveStatus,
        stakedNft, // eslint-disable-line no-unused-vars
        withdraw,
        totalReward,
        rewardPerday,
        constantReward
    } = useContext(BlockchainContext);
    const [activeStake, setActiveStake] = useState() // eslint-disable-line no-unused-vars
        ...
        <div className='container'>
            <div className='row box-row justify-content-between align-items-end mt-3'>
                <span className='col-md-6 col-sm-6 info-holder left'>
                    <p className='mb-2 top-text'>{tokenStaked / 100}% Frens Staked: </p>
            ...
            <div className='row justify-content-between'>
                <div className='col-md-6'>
                    ...
                    <div className='main-box'>
                        ...
                        <p className='balance-text'>{walletBalance} $GGAS</p>
                    </div>
                </div>
                <div className='col-md-6'>
                    <div className='main-box'>
            ...
            <div className='row box-row justify-content-between my-3'>
                <div className='col-md-6'>
                    <div className='main-box'>
                        <p className='box-text'>{tokenStakedByuser} staked Frens</p>
                        <p className='box-text'>Pending $GGAS Reward: {totalReward}</p>
                        <button className='box-btn my-3' onClick={() => {
                            withdraw()
                        }}>Claim</button>
                        <p className='box-text'>Daily Reward: {constantReward} $GGAS / Fren</p>
                        <p className='box-text'>You are currently earning: {rewardPerday} $GGAS / Day</p>
                    </div>
                </div>
                <div className='col-md-6'>
                    {
                        approveStatus === false ? (
                            <div className='main-box'>
                                ...
                                <p className='box-text'>Step 2: Once complete, stake your Frens.</p>
